...
for el in os.listdir(sys.argv[1]+"/dat-files/"):
	...
	for i in range(len(Xt)):
		if predictions[i] in loc_types_1.keys():
			...
			print id_protein[i]+"\t"+str(subcons_prediction)+"\t"+str(round(float(probs[i][0]),2))+"\t"+str(round(float(probs[i][1]),2))+"\t"+str(round(float(probs[i][2]),2))+"\t"+str(round(float(probs[i][3]),2))+"\t"+str(round(float(probs[i][4]),2))+"\t"+str(round(float(probs[i][5]),2))+"\t"+str(round(float(probs[i][6]),2))+"\t"+str(round(float(probs[i][7]),2))+"\t"+str(round(float(probs[i][8]),2))
