...
p <- ggplot(data=data.1,aes(x=X,y=value,fill=variable))+geom_bar(width=.4,stat="identity",colour="black")+coord_flip()+ scale_fill_manual(values = c("#33499a", "#ed3747","#008000", "#f9971a", "#a04c97","#12CFF5","#66CC00","#FF007F"))
